...
class Hub:
    ...
    def catalog(self, для_кого=None):
        ...
        out = []
        for r in комнаты:
            # Дом — не сервер. В него ходят в гости через «Друзей», а в
            # общем списке ему делать нечего: игрок выбирал бы «Дом: Мурка»
            # наравне с «Дружной поляной» и не понимал, что это такое.
            if r.mode == 'home':
                continue
